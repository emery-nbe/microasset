...
@section('title', 'MicroAsset | Mon Panier')
        ...
        <div class="col-lg-4">
            <form class="mb-30" action="">
                <div class="input-group">
                    <input type="text" class="form-control border-0 p-4" placeholder="Code Coupon">
                    <div class="input-group-append">
                        <button class="btn btn-primary">Appliquer le coupon</button>
                    </div>
                </div>
            </form>
            <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Detail du Panier</span></h5>
            <div class="bg-light p-30 mb-5">
                <div class="border-bottom pb-2">
                    ...
                    <div class="d-flex justify-content-between">
                        <h6 class="font-weight-medium">Frais livraison</h6>
                ...
                <div class="pt-2">
                    ...
                    <a href="{{route('paiement')}}" class="text-decoration-none" ><button class="btn btn-block btn-primary font-weight-bold my-3 py-3">Payer</button></a>
                </div>
            </div>
        </div>
    </div>
